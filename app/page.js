...
;
  ...
  return (
    ...
    .shared-badge{display:inline-block;font-size:9px;padding:2px 6px;border-radius:4px;background:rgba(93,202,165,0.15);color:#5dcaa5;margin-left:8px;vertical-align:middle;}</style>
