    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .google-btn{width:100%;padding:12px;border-radius:10px;border:1.5px solid #2e2e38;background:transparent;color:#f0ede8;font-family:'DM Mono',monospace;font-size:13px;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;margin-bottom:20px;}
        ...
        .field input{width:100%;background:#16161a;border:1.5px solid #2e2e38;border-radius:10px;color:#f0ede8;font-family:'DM Mono',monospace;font-size:14px;padding:11px 14px;outline:none;}
        .field input:focus{border-color:#e8a020;}
        .submit{width:100%;padding:13px;border-radius:10px;background:#e8a020;color:#000;font-family:'DM Mono',monospace;font-size:14px;font-weight:500;border:none;cursor:pointer;margin-top:8px;}
        ...
        .tab{flex:1;padding:8px;text-align:center;font-size:11px;letter-spacing:.05em;text-transform:uppercase;cursor:pointer;border-radius:8px;border:none;background:transparent;color:#4a4945;font-family:'DM Mono',monospace;}
        .tab.active{background:#1e1e24;color:#f0ede8;}
        .msg{margin-top:14px;font-size:12px;text-align:center;color:#e8a020;}
      `}</style>
      <div className="card">
        ...
        <div className="tabs">
          {['signin','signup','magic'].map(m => (
            <button key={m} className={`tab ${mode===m?'active':''}`} onClick={() => { setMode(m); setMsg(''); }}>
