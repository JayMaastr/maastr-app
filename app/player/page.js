  ...
  return(<>
    ...
    <div className={'td-modal'+(open?' td-open':'')}>
      ...
      <div className="td-comments-scroll">
        {notes.length>0?notes.map(n=>(<div key={n.id} data-comment-id={n.id} className="td-comment-card" onClick={()=>n.timestamp_sec!=null&&onSeekToTime(n.timestamp_sec)} style={activeNoteId===n.id?{background:'#1a1a1a',borderRadius:'8px',margin:'0 -4px',padding:'10px 8px'}:{}}>
