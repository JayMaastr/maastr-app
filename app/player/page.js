...
@media(min-width:769px){.ps-mobile-hero{display:none!important;}body:has(.ps-sidebar) .ps-waveform-bar{margin-left:200px;}body:has(.ps-sidebar) .ps-waveform-bar{min-height:200px;}body:has(.ps-sidebar) .page{margin-left:200px;}}
    ...
    .sc-person{display:flex;align-items:center;gap:8px;}.sc-person-info{min-width:0;flex:1;}.sc-person-name{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}.sc-kebab-wrap{position:relative;flex-shrink:0;}.sc-kebab{width:20px;height:20px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;cursor:pointer;border-radius:4px;border:none;background:transparent;padding:0;}.sc-kebab:hover{background:rgba(138,135,128,0.15);}.sc-kebab-dot{width:3px;height:3px;border-radius:50%;background:#8a8780;display:block;}.sc-menu-overlay{position:fixed;top:0;left:0;right:0;bottom:0;z-index:99;}.sc-menu{position:absolute;right:0;top:100%;margin-top:2px;background:#111113;border:1px solid #2e2e38;border-radius:8px;padding:4px 0;min-width:140px;z-index:100;}.sc-menu-item{display:flex;align-items:center;gap:8px;padding:7px 12px;font-size:11px;font-family:'DM Mono',monospace;cursor:pointer;white-space:nowrap;color:#8a8780;}.sc-menu-item:hover{background:rgba(138,135,128,0.08);color:#f0ede8;}.sc-menu-sep{height:1px;background:#24242c;margin:3px 8px;}.sc-menu-danger{color:#e24b4a;}.sc-menu-danger:hover{background:rgba(226,75,74,0.1);color:#e24b4a;}.sc-confirm-overlay{position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;z-index:9999;}.sc-confirm-card{background:#111113;border:1px solid #24242c;border-radius:16px;padding:24px 20px;max-width:320px;width:90%;text-align:center;}.sc-confirm-card h3{font-family:'DM Serif Display',Georgia,serif;font-size:16px;margin:0 0 8px;color:#f0ede8;}.sc-confirm-card p{font-size:11px;color:#8a8780;line-height:1.6;margin:0 0 16px;}.sc-confirm-email{color:#e8a020;}.sc-confirm-btns{display:flex;gap:8px;}.sc-confirm-btn{flex:1;padding:10px;border-radius:8px;border:1px solid #2e2e38;background:transparent;color:#8a8780;font-family:'DM Mono',monospace;font-size:11px;cursor:pointer;}.sc-confirm-btn:hover{border-color:#f0ede8;color:#f0ede8;}.sc-confirm-btn-danger{background:#e24b4a;border-color:#e24b4a;color:#fff;}.sc-confirm-btn-danger:hover{opacity:0.85;border-color:#e24b4a;color:#fff;}.sc-add:hover{color:var(--amber);}
