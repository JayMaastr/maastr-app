...
@media(min-width:769px){.ps-mobile-hero{display:none!important;}body:has(.ps-sidebar) .ps-waveform-bar{margin-left:200px;}body:has(.ps-sidebar) .page{margin-left:200px;}body:has(.ps-sidebar) .ps-controls-bar{left:200px;}}`}</style>
