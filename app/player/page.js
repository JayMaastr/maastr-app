...
@media(max-width:768px){.ps-sidebar{display:none!important;}.ps-mobile-hero{display:none;}.ps-controls-bar .ps-art+div>div:first-child{display:none!important;}.ps-waveform canvas{height:80px!important;}.ps-waveform-bar{padding:6px 12px 4px!important;}.page-header{float:right;padding:4px 0 0!important;}.tracks-lbl{margin:0!important;padding-top:10px;}}
