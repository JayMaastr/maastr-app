...
@media(min-width:769px){.ps-mobile-hero{display:none!important;}body:has(.ps-sidebar) .ps-waveform-bar{margin-left:200px;}body:has(.ps-sidebar) .ps-waveform-bar{min-height:200px;}body:has(.ps-sidebar) .page{margin-left:200px;}}
    ...
    .sc-person{display:flex;align-items:center;gap:8px;padding:5px 0;}
    .sc-avatar{width:24px;height:24px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:9px;font-weight:500;flex-shrink:0;}
    .sc-person-info{flex:1;min-width:0;}
    .sc-person-name{font-size:10px;color:var(--t2);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
    .sc-status{font-size:8px;}.sc-accepted{color:#50c878;}.sc-pending{color:var(--amber);}
    .sc-add{display:flex;align-items:center;gap:8px;padding:6px 0;cursor:pointer;color:var(--t3);font-size:10px;}.sc-person{display:flex;align-items:center;gap:8px;}.sc-person-info{min-width:0;flex:1;}.sc-person-name{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}.sc-remove{width:16px;height:16px;border-radius:50%;border:1px solid rgba(226,75,74,0.25);background:rgba(226,75,74,0.1);color:#e24b4a;font-size:10px;display:flex;align-items:center;justify-content:center;cursor:pointer;padding:0;font-family:inherit;line-height:1;flex-shrink:0;}.sc-remove:hover{background:rgba(226,75,74,0.25);border-color:#e24b4a;}.sc-confirm-overlay{position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;z-index:9999;}.sc-confirm-card{background:#111113;border:1px solid #24242c;border-radius:16px;padding:24px 20px;max-width:320px;width:90%;text-align:center;}.sc-confirm-card h3{font-family:'DM Serif Display',Georgia,serif;font-size:16px;margin:0 0 8px;color:#f0ede8;}.sc-confirm-card p{font-size:11px;color:#8a8780;line-height:1.6;margin:0 0 16px;}.sc-confirm-email{color:#e8a020;}.sc-confirm-btns{display:flex;gap:8px;}.sc-confirm-btn{flex:1;padding:10px;border-radius:8px;border:1px solid #2e2e38;background:transparent;color:#8a8780;font-family:'DM Mono',monospace;font-size:11px;cursor:pointer;}.sc-confirm-btn:hover{border-color:#f0ede8;color:#f0ede8;}.sc-confirm-btn-danger{background:#e24b4a;border-color:#e24b4a;color:#fff;}.sc-confirm-btn-danger:hover{opacity:0.85;border-color:#e24b4a;color:#fff;}.sc-add:hover{color:var(--amber);}
